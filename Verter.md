...
1. Перейти в папку репозитория `cd T06D09`
2. Перейти в папку материалов `cd materials`
3. Перейти в папку linters `cd linters`
4. Скопировать файл `.clang-format` в папку `src` прописываем команду `cp .clang-format ../../src/`
5. Переходим в папку `src` прописываем команду `cd ../../src`
...
8. Если в консоли пусто, то файл исправлен
